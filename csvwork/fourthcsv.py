...
# ячейке написано название магазина, а в ячейках, начиная со второй - цена на
...
# раньше в алфавитном порядке. Если этот товар продается в нескольких
# магазинах по одной минимальной цене, то выведите минимальное в алфавитном
# порядке название магазина.

with open('input (3).csv', 'r', encoding='utf-8') as infile:
    prodlist = infile.readline().split(';')
    a =[]
    for line in infile.readlines()[1:]:
        a.extend(list(map(int, line.split(';'))))
        print(a)
        a = []
